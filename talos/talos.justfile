...
# Pre-render addons to addons-rendered.yaml for cluster.extraManifests (Talos
# applies it at bootstrap — no Helm/Kustomize on the node). Re-run after a chart
# bump. Commit the result; nodes fetch it from raw.githubusercontent.com.
render-addons:
    #!/usr/bin/env bash
    set -euo pipefail
    {
